...
require_once(MODULES_PATH.'/rlsworks/config/rlsworks_constants.php');
class Rlsworks_model extends Base_module_model {
	
	public $record_class = 'Rlswork'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('rlsworks'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('footerMenuOpts.id, footerMenuOpts.title, footerMenuOpts.published....'); uncomment and  change to the fields to be displayed
...
class Rlswork_model extends Base_module_record {

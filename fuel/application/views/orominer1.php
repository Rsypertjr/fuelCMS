...
function doSystems(xmlDoc,nme,nodeDoc,xnodeDoc,tableDoc)
{
	...
	if(nodeDoc==null)
		...
		xml = "<top><Active_Nodes></Active_Nodes><Draw_Nodes></Draw_Nodes><All></All><Select></Select><Contacts></Contacts><Tables></Tables></top>";
...
function loadGUI()  // This function loads the HTML of gui on body load
{
	   ...
	   //USE JQuery to Maintain Dynamic Font Sizes on GUI during Zoom
		...
		// Prompts Alerting to Expanding Graphical Display
			 ...
			 $('#gphdisp').mouseenter(function()
				{
					//$('#dispframe').append($('#panel'));
					//$('#panel').html("You Can Point to Graph Display and Enlarge It.<br/>Then Point to Edge to Restore.");
					$('#panel').slideUp("slow");
				//	$('#gphmess').html('Click Here For Menu')

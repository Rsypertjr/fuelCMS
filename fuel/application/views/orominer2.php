...
function adjustViewers(){
		$('#grview').on('mouseenter mouseover',function()
				...
				.on('mouseleave',function()
				{
					...
					$('#grahdr').css('display','block');	
				
			
				});
				
		$('#hierdiv').on('mouseenter mouseover',function()
				{
				/*	$grhdr = $('#grahdr').css('display','block');
					$grhdr.html("<div id='intromess'>MOVE MOUSE TO RIGHT EDGE TO SEE GRAPH</div>");
				...
				.on('mouseleave',function()
				{
					...
					$('#hierdiv').css('display','block');
					$('#imgview').css('display','block');
					$('#grview').css('display','block').prepend($grhdr);
					$('#grview').css('display','block');

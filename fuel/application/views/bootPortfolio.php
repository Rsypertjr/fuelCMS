						...
						<div class="panel-body">
							<li class="list-group-item list-group-item-success">
							 ...
							 <li class="list-group-item">
								...
								<p>See Tabular and Graphic Parser of 2020 Presidential Election Voting. uses Vue.js, JQuery, Bootstrap, Datatables, and JChartfx, on the front-end, and PHP on the backend 
